 ...
 * 税务机关库房库存VO
 * 
 * <p>Java class for FPSwjgkfkcVO complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="FPSwjgkfkcVO">
 *   &lt;complexContent>
...
@XmlType(name = "FPSwjgkfkcVO", propOrder = {
    "fpzlDm",
    "sjgsdq",
    "fpkfDm",
    "fpzzhm",
...
@XmlSeeAlso({
    FPFpSwjgkfkcVO.class,
    FPSwjgkfkcJcVO.class
})
public class FPSwjgkfkcVO {
